...
def gabor(img, precision=15):
    """
        Binarise the image using Gabor filters to also obtained
        an enhacement of the image.
    ...
    if gabPrec != precision:
        EnGab.generateKernel(precision)

    return EnGab.enhacementGabor(img)
